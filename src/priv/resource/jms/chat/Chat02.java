package priv.resource.jms.chat;
...
public class Chat02 implements MessageListener {
	...
	// 用于初始化chat的构造函数
	public Chat02(String topicFactory, String topicName, String username) throws Exception {
...
//			}
			...
			String username = "zhuzh2";
			Chat02 chat = new Chat02(topicFactory, topicName, username);
