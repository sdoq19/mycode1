...
public class VerifyUtil {
	...
	/**
	 * 判断是否为联通G网手机号码。<br/>
	 * 目前包含号段130 131 132 155 156 186 185 145。
	 * 
	 * @param phoneNumber
	 *            手机号码
	 * @return 如果是返回true，不是返回false
	 */
	public static boolean isGNet(String phoneNumber) {
		Pattern pattern = Pattern
				.compile("13[0-2][0-9]{8}|15[5-6][0-9]{8}|18[5-6][0-9]{8}|14[5][0-9]{8}");
	 ...
	 * @return 如果是返回true，不是返回false。
	 */
	public static boolean isCNet(String phoneNumber) {
		Pattern pattern = Pattern
	...
	/**
	 * 判断是否是移动手机号码。<br/>
	 * 目前包含号段：134-139 150 151 152 157 158 159 182 183 187 188。
	 * 
	 * @param phoneNumber
	 *            手机号码
	 * @return 如果是移动手机号码返回true 否则返回false。
	 */
	public static boolean isMobileNet(String phoneNumber) {
		Pattern pattern = Pattern
				.compile("13[4-9][0-9]{8}|15[012789][0-9]{8}|18[2378][0-9]{8}");
		return pattern.matcher(phoneNumber).matches();
	}
